...
class ReconstructDistributions:
    ...
    def RemoveSelectionEffects(df, pars, rate_w, ref_cosmo, injections):
        ...
        plots_inputs['plot-dict-dL']  = get_plot_parameters(pars, dL_array,   pars['bounds-dL'][0], pars['bounds-dL'][1],                           'LuminosityDistanceDistribution_DetectorFrame', '#7E375B', '$d_L\ [Mpc]$',       '$p(d_L)$', pars['model-rate'])
